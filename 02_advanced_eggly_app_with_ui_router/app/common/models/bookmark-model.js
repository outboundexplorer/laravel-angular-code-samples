angular.module('eggly.models.bookmarks', [
    ...
    .service('BookmarksModel', function($http, $q){
        ...
        var bookmarks;
        var URLS = {
            FETCH: '/angularjs/02_advanced_eggly_app_with_ui_router/data/bookmarks.json'
        };
        ...
        model.createBookmark = function(bookmark){
            ...
            // In real production code, we would want to use a method that is a little more advanced and would definitely
            // guarantee that the id is unique.
